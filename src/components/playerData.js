const players = {
  daniel: {
    ...
    gameplayImage: require('../../images/daniel-kahle/daniel-face-with-border-small.png'),
  ...
  charkie: {
    ...
    gameplayImage: require('../../images/charkie/charkie-snake-with-border-small.png'),
  ...
  betsy: {
    ...
    gameplayImage: require('../../images/betsy-jones/betsy-snake-with-border-small.png'),
  ...
  dutch: {
    ...
    gameplayImage: require('../../images/dutch/dutch-snake-with-border-small.png'),
    landingText: require('../../images/dutch/dutch-logo-words.png'),
    itemToEat: require('../../images/dutch/championship-belt-small.png'),
    faceWidth: 365,
    faceHeight: 507,
    itemWidth: 785,
    itemHeight: 255,
  ...
  gabe: {
    ...
    gameplayImage: require('../../images/gabe-rees/gabe-snake-with-border-small.png'),
    landingText: require('../../images/gabe-rees/gabe-logo-words.png'),
    itemToEat: require('../../images/gabe-rees/beer-can-small.png'),
    faceWidth: 382,
    faceHeight: 490,
    itemWidth: 805,
    itemHeight: 1283,
  ...
  neil: {
    ...
    gameplayImage: require('../../images/neil/neil-snake-with-border-small.png'),
    landingText: require('../../images/neil/neil-logo-words.png'),
    itemToEat: require('../../images/neil/water-small.png'),
    faceWidth: 505,
    faceHeight: 758,
    itemWidth: 280,
    itemHeight: 694,
  ...
  owenWilson: {
    ...
    itemToEat: require('../../images/owen-wilson/chicken-wing-small.png'),
    faceWidth: 200,
    faceHeight: 233,
    itemWidth: 257,
    itemHeight: 196,
